  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        -- <C-t> to jump back for all the commands
    ...
    vim.diagnostic.config {
      ...
      virtual_text = {
        ...
        prefix = function(diagnostic)
          return inlineDiagnosticsSigns[vim.diagnostic.severity[diagnostic.severity]]
        end,
